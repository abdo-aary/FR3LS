...
from experiments.trainers.trainer_ae import vanilla_ae_trainer
from models.aldy.aldy_vanilla_ae_ts2vec import ALDy
import torch as t
...
class ALDyExperiment(Experiment):
    ...
    def instance(self,
        ...
        _ = vanilla_ae_trainer(snapshot_manager=snapshot_manager,
                               model=model,
